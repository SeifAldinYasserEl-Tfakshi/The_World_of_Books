...
void main() => runApp(lab4());

class lab4 extends StatelessWidget {
  final String title = 'مكتبة الثقافة والعلوم';
    ...
    body: Container(width: double.infinity,
      ...
      child: Column(
        ...
        children: [
          ...
          buildButton(
            text: 'Map',
            onClicked: () => Utils.openLink(url: 'https://www.google.com/maps/dir/29.9772683,31.2531469/%D9%85%D9%83%D8%AA%D8%A8%D8%A7%D8%AA+%D9%85%D8%AD%D8%A7%D9%81%D8%B8+%D8%A7%D9%84%D9%82%D8%A7%D9%87%D8%B1%D8%A9%E2%80%AD%E2%80%AD/@30.0127753,31.2180413,13z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x14583fa1dec12091:0xcbac68244856f5e7!2m2!1d31.2627919!2d30.0449516'),
          ),

          buildButton(
            text: 'Call',
            onClicked: () =>
                Utils.openPhoneCall(phoneNumber: '+0100 310 3750'),
          ),
          buildButton(
            text: ' Sms',
            onClicked: () => Utils.openSMS(phoneNumber: '+0100 310 3750'),
          ),
