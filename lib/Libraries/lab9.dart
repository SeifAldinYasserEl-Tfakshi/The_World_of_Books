...
void main() => runApp(lab9());

class lab9 extends StatelessWidget {
  final String title = 'مكتبة الاسكندرية';
    ...
    body: Container(width: double.infinity,
      ...
      child: Column(
        ...
        children: [
          ...
          buildButton(
            text: 'Map',
            onClicked: () => Utils.openLink(url: 'https://www.google.com/maps/dir/29.9772683,31.2531469/%D9%85%D9%83%D8%AA%D8%A8%D8%A9+%D8%A7%D9%84%D8%A7%D8%B3%D9%83%D9%86%D8%AF%D8%B1%D9%8A%D8%A9%E2%80%AD%E2%80%AD/@30.5793958,29.400354,8z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x14f5c38a0562fe85:0xa34cc632ec23e7!2m2!1d29.9092012!2d31.2088705'),
          ),

          buildButton(
            text: 'Call',
            onClicked: () =>
                Utils.openPhoneCall(phoneNumber: '+03 4839999'),
          ),
          buildButton(
            text: ' Sms',
            onClicked: () => Utils.openSMS(phoneNumber: '+03 4839999'),
          ),
