...
class _MyAppState extends State<englishbook> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Education%2F6940128-Teaching-English-To-Children.pdf?alt=media&token=b3ae5eca-fed1-4cb0-90e7-6e138ab0b63c";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/englishbook.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
