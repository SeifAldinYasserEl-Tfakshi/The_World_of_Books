...
class _MyAppState extends State<cook> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Foods%2FCookItalian-obooko-fd0003.pdf?alt=media&token=345693f3-a3a9-4dec-abc8-cb611b209887";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/cook.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
