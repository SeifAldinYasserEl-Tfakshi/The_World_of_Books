...
class _MyAppState extends State<nutri> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Foods%2Fdownload-pdf-ebooks.org-1462532236Sp5W0.pdf?alt=media&token=3efacd1b-4fb4-44d7-9df8-2f8c816df6db";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/nutri.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
