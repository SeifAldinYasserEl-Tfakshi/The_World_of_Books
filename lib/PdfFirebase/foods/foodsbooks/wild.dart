...
class _MyAppState extends State<wild> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Foods%2Fwild-delights-obooko.pdf?alt=media&token=8213a2f7-6a1f-4ff8-b290-bfce995cc721";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/wild.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
