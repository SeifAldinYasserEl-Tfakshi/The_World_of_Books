...
class andalos extends StatefulWidget {
  @override
  _MyAppState createState() => new _MyAppState();
}

class _MyAppState extends State<andalos> {
  String pathPDF = "";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/andalos.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
