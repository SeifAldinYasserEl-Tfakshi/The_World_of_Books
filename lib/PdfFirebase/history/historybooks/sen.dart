...
class _MyAppState extends State<sen> {
  String pathPDF = "";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/sen.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
