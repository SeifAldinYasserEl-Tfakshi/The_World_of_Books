...
class _MyAppState extends State<adb> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Literature%2Fadb.pdf?alt=media&token=4057262b-58d4-4c96-8417-5e58336fd405";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/adb.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
