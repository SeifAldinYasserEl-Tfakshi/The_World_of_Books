...
class _MyAppState extends State<bank> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Literature%2Fbank.pdf?alt=media&token=0bf467b2-26a4-4f9b-a71d-840b4be8ad1b";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/bank.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
