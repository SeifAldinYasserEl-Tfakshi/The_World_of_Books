...
class _MyAppState extends State<astronomy> {
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Sciences%2Fastronomy.pdf?alt=media&token=f35522ae-aa2f-4323-a2df-195fcc8f8da5";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/astronomy.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
