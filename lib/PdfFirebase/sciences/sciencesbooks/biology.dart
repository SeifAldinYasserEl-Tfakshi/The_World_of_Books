...
class _MyAppState extends State<biology> {
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Sciences%2Fbiology.pdf?alt=media&token=cac4cb9f-058d-4515-81a4-1103d2924351";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/biology.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
