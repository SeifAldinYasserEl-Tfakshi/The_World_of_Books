...
class _MyAppState extends State<chemistry> {
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Sciences%2Fchemistry.pdf?alt=media&token=3d5d5a9d-8bfa-45bf-9610-902db1d6f669";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/chemistry.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
