...
class _MyAppState extends State<physics> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Sciences%2Fphysics.pdf?alt=media&token=7cef28bc-33ea-4c8c-8f0d-dcd72298eb82";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/physics.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
