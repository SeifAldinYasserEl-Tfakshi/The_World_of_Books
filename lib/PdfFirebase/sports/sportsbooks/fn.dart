...
class _MyAppState extends State<fn> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Sports%2Ffn.pdf?alt=media&token=82aa87cd-fa48-4512-b234-e559fdd315f4";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/fn.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
