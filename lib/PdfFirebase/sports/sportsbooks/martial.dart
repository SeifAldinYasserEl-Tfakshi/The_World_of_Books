...
class _MyAppState extends State<martial> {
  String pathPDF = "";
  ...
  Future<File> createFileOfPdfUrl() async {
    final url = "https://firebasestorage.googleapis.com/v0/b/the-world-of-books-60b2e.appspot.com/o/Sports%2Fmartial.pdf?alt=media&token=826ffb74-7e23-43d7-8c3b-9f90ea0ec346";
      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/pics/martial.jpg"),fit: BoxFit.fill,
          )
        ),
        child: Column(
