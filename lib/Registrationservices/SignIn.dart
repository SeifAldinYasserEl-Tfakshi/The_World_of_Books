      ...
      body: Container(width: double.infinity,
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage("images/pics/logopage.jpg"),fit: BoxFit.fill)),
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 5),
                      FlatButton(
                        child: Text('Not registerd? Sign up',style: TextStyle(fontSize: 18),),
                        onPressed: (){
                      ...
                      Row(
                        ...
                        children: [Container(child: RaisedButton(
                          ...
                          shape: RoundedRectangleBorder(
                            ...
                            color: Colors.white,fontSize: 25)), onPressed: () async{
                          ...
                          if (user!=null){
                            AwesomeDialog(
                              ...
                              btnOkOnPress: () {   Navigator.of(context).pushReplacementNamed("apppage");},
                            )..show();
                          }
                        },
                        ),),
